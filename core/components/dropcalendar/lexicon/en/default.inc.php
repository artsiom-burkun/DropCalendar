...
$_lang['dropcalendar_item_err_remove'] = 'An error occurred while trying to remove the Item.';
$_lang['dropcalendar_item_err_save'] = 'An error occurred while trying to save the Item.';
